...
Для запуска приложения необходимо выполнить  в папке config команду в консоле:

`python manage.py runserver`

Для успешного запуска проекта необходимо установить следующие библиотеки(если они не установлены):
